...
let s:colours = Colours({
  \   'b0':          { 'gui': "#0a0822", '16': 'NONE', 'comment': 'background'           }
  \ , 'b00':         { 'gui': "#0c132f", '16': 'NONE', 'comment': 'background'           }
...
Hi CursorLine bg=b00
Hi CursorColumn bg=b00
Hi ColorColumn bg=b00
...
Hi Folded fg=cyan bg=b0
Hi FoldColumn fg=cyan bg=b0
" }}}
